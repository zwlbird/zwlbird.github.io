...
QT_MOC_LITERAL(1, 5, 14), // "signal_sendMsg"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 19), // "signal_deleteThread"
QT_MOC_LITERAL(4, 41, 15), // "slot_UDPreceive"
QT_MOC_LITERAL(5, 57, 6) // "update"

    },
    "test\0signal_sendMsg\0\0signal_deleteThread\0"
    "slot_UDPreceive\0update"
};
...
void test::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (test::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&test::signal_sendMsg)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (test::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&test::signal_deleteThread)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void test::signal_sendMsg(QByteArray _t1)
{
