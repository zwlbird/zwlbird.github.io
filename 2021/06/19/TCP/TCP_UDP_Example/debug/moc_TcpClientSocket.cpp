...
#include "../TCPServer_Qt/TcpClientSocket.h"
...
QT_MOC_LITERAL(1, 16, 18), // "signal_sendMessage"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 25), // "signal_clientdisconnected"
QT_MOC_LITERAL(4, 62, 7) // "qintptr"

    },
    "TcpClientSocket\0signal_sendMessage\0\0"
    "signal_clientdisconnected\0qintptr"
};
...
void TcpClientSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->signal_clientdisconnected((*reinterpret_cast< qintptr(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TcpClientSocket::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpClientSocket::signal_sendMessage)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpClientSocket::signal_clientdisconnected)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void TcpClientSocket::signal_sendMessage(QByteArray _t1)
{
...
// SIGNAL 1
void TcpClientSocket::signal_clientdisconnected(qintptr _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
